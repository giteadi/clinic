    ...
    <section style={{ background: COLORS.cream, padding: "80px 32px" }}>
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }}>
          <h2 style={{ fontFamily: "'Playfair Display', serif", fontSize: 36, color: COLORS.navy, marginBottom: 16, textAlign: "center", fontWeight: 700 }}>
            Have Questions?
          </h2>
        ...
        <motion.form initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <div style={{ display: "grid", gap: 24 }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 24 }}>
              <div>
                <label style={{ display: "block", color: COLORS.navy, fontWeight: 600, marginBottom: 8, fontSize: 14 }}>
                  Name
                </label>
                <input
                  type="text"
